...
public sealed record ProjectSummaryResponse(long Id, long CompanyId, string CompanyName, string Title, string Code, string Address, string? GoogleMapsUrl, string? CurrentPhaseCode, bool IsArchived, IReadOnlyList<ProjectClientResponse> Clients, IReadOnlyList<ProjectMemberResponse> Members);
public sealed record ProjectResponse(long Id, long CompanyId, string CompanyName, string Title, string Code, string Address, string? GoogleMapsUrl, bool IsArchived, IReadOnlyList<ProjectClientResponse> Clients, IReadOnlyList<ProjectMemberResponse> Members, IReadOnlyList<ProjectPhaseResponse> Phases, bool CanEditTimeline);
public sealed record CreateProjectRequest(string Title, string Code, string Address, string? GoogleMapsUrl, IReadOnlyList<long> ClientIds, IReadOnlyList<long> EmployeeIds, IReadOnlyList<string>? PhaseCodes, int? CurrentPhaseIndex);
public sealed record UpdateProjectRequest(string Title, string Code, string Address, string? GoogleMapsUrl, IReadOnlyList<long> ClientIds);
