...
public sealed record ProjectSummaryResponse(long Id, string Title, string Code, string Address, string? GoogleMapsUrl, string? CurrentPhaseCode, bool IsArchived, ProjectClientResponse? Client, IReadOnlyList<ProjectMemberResponse> Members);
public sealed record ProjectResponse(long Id, string Title, string Code, string Address, string? GoogleMapsUrl, bool IsArchived, ProjectClientResponse? Client, IReadOnlyList<ProjectMemberResponse> Members, IReadOnlyList<ProjectPhaseResponse> Phases, bool CanEditTimeline);
