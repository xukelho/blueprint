...
namespace Blueprint.Api.Data.Migrations
{
    ...
    [Migration("20260906194107_AddProjectPartConversations")]
    partial class AddProjectPartConversations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blueprint.Api.Data.ProjectPartConversation", b =>
                {
                    ...
                    b.Property<double>("AnchorX")
                        ...
                        .HasColumnName("anchor_x");

                    b.Property<double>("AnchorY")
                        .HasColumnType("double precision")
                        .HasColumnName("anchor_y");
                    ...
                    b.HasIndex("DocumentId", "TargetKey")
                        .IsUnique();

                    b.HasIndex("ProjectId", "DocumentId");

                    b.ToTable("project_part_conversations", (string)null);
                });

            modelBuilder.Entity("Blueprint.Api.Data.ProjectPartConversationMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("project_part_conversation_messages", (string)null);
                });
            ...
            modelBuilder.Entity("Blueprint.Api.Data.ProjectPartConversation", b =>
                {
                    b.HasOne("Blueprint.Api.Data.ProjectDocument", "Document")
                        .WithMany("PartConversations")
            ...
            modelBuilder.Entity("Blueprint.Api.Data.ProjectPartConversationMessage", b =>
                {
                    ...
                    b.HasOne("Blueprint.Api.Data.ProjectPartConversation", "Conversation")
                        .WithMany("Messages")
